...
func TestValidateHostname(t *testing.T) {
	namespace := configs.Namespace{Type: configs.NEWUTS}
	config := &configs.Config{
		Rootfs:     "/var",
		Hostname:   "runc",
		Namespaces: configs.Namespaces{namespace},
	}
...
func TestValidateSecurityWithMaskPaths(t *testing.T) {
	namespace := configs.Namespace{Type: configs.NEWNS}
	config := &configs.Config{
		Rootfs:     "/var",
...
func TestValidateUsernamespace(t *testing.T) {
	namespace := configs.Namespace{Type: configs.NEWUSER}
	config := &configs.Config{
		Rootfs:     "/var",
		Namespaces: configs.Namespaces{namespace},
	}
